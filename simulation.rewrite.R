...
est.sim.rst.redo3.glm.all.interaction.SL <- data.frame(
  seed = seed.list,
  n = rep(2000, 1000),
...
save(est.sim.rst.redo1.glm.mu, file="est.sim.rst.redo1.glm.mu.RData")

# analysis
rst <- est.sim.rst.redo3.glm.all.interaction.SL
# 1) bias
# psi
